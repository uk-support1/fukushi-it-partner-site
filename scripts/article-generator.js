  ...
  const instructions = "あなたは福祉ITパートナーの編集・執筆担当です。選定済みテーマから、日本語の実務的なブログ記事を作成してください。" +
    ...
    (hasVideoSource
      ? "sourceInformationのうちkindがvideoのものは、公的機関の発表ではなく個人の配信者・専門職による動画での発信です。制度や事実であるかのように断定せず、「〇〇さんが動画で紹介している考え方」のように発信者個人の見解・経験として扱います。診断や治療方針など医療的判断に踏み込む断定はせず、詳しくは動画本編の確認を読者に促してください。添付された動画があれば、その実際の内容を確認したうえで要約・言及してください。動画から確認できない内容は断定しません。" +
        "当社見解の中では、動画の発信者が述べている具体的な内容に一度触れたうえで、「福祉ITパートナーとしても、動画内で〇〇さんが指摘しているように〇〇になっていくと感じており、そのお手伝いをしていきたい」という形で、共感する点・今後の見通し・当社として力になりたい姿勢を一言添えてください。発信者の発言をそのまま繰り返すのではなく、当社自身の考えとして書き、誇張した断定はしません。"
      : "");
